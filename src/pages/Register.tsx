      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        ...
        >
            ...
            <div className="mb-10 text-center md:text-left">
                <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-3">Criar Conta</h2>
                <p className="text-slate-500 font-medium tracking-wide">Comece agora mesmo integrando a sua primeira empresa.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-[11px] font-bold uppercase tracking-wider text-slate-500 mb-2">Senha</label>
                <input 
                  type="password" 
                  required
                  placeholder="••••••••"
            ...
            <p className="mt-10 text-center text-sm font-medium text-slate-500">
              Já tem conta? <Link to="/login" className="text-emerald-500 font-bold hover:text-emerald-400 transition-colors">Fazer Login</Link>
            </p>
        </motion.div>
      </div>
